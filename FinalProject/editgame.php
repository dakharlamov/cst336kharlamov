...
<head>
    ...
    $tableString = "";
    $tableString .= '<form method="GET" action="php/updategame.php"><table id="games-table">';
    ...
    $tableString .= '</th>';
    $tableString .= '<td>';
    $tableString .= '<input type="text" name="title" value="'.$data[0]["gametitle"].'">';
    $tableString .= '</td>';
    $tableString .= '</tr>';
    $tableString .= '<tr>';
    $tableString .= '<th>';
    ...
    $tableString .= '</th>';
    $tableString .= '<td>';
    $tableString .= '<input type="number" name="year" value="'.$data[0]["releaseyear"].'">';
    $tableString .= '</td>';
    $tableString .= '</tr>';
    $tableString .= '<tr>';
    $tableString .= '<th>';
    ...
    foreach($genreData as $elem){
        if($elem["genre"] == $data[0]["genre"]){
            $tableString .= '<option selected="selected" value="'.$elem["genreid"].'">'.$elem["genre"].'</option>';
        }else{
    ...
    foreach($esrbData as $elem){
        if($elem["esrbrating"] == $data[0]["esrbrating"]){
            $tableString .= '<option selected="selected" value="'.$elem["esrbid"].'">'.$elem["esrbrating"].'</option>';
        }else{
            $tableString .= '<option value="'.$elem["esrbid"].'">'.$elem["esrbrating"].'</option>';
        }
    ...
    $tableString .= '</th>';
    $tableString .= '<td>';
    $tableString .= '<input type="number" name="rating" value="'.$data[0]["rating"].'">';
    $tableString .= '</td>';
    $tableString .= '</tr>';
    $tableString .= '<tr>';
    $tableString .= '<th>';
    ...
    $tableString .= '</th>';
    $tableString .= '<td>';
    $tableString .= '<input type="text" name="price" value="'.$data[0]["price"].'">';
    $tableString .= '</td>';
    $tableString .= '</tr>';
    $tableString .= '<th>';
    $tableString .= '</th>';
    $tableString .= '<td>';
    $tableString .= '<button type="submit" name="gid" class="btn btn-warning" value="' . $data[0]["gameid"] . '">Update</button>';
    $tableString .= '</td>';
    $tableString .= '</tr>';
    ...
    <main role="main" class="container">
      ...
      <div id="game-list">
        <?php
            echo $tableString;
            echo '<br><br><br><br>';
            echo '<form method="GET" action="php/deletegame.php"><button type="submit" name="gid" class="btn btn-danger" value="' . $data[0]["gameid"] . '">Delete</button></form>';
        ?>
      </div>
